    ...
    <div>
      <section className="bg-white dark:bg-pink-700">
        ...
        <div className="bg-pink-900 p-10">
          <form className="mx-auto flex flex-row justify-evenly relative">
            
            <div className="relative w-full max-w-xs">
              <div className="block w-full mb-2 text-sm font-medium text-white">
                Leave a Company Review
              </div>
              <div
                id="default-search"
                className="block w-full p-4 text-sm text-pink-900 border border-pink-900 rounded-lg bg-white focus:ring-pink-900 focus:border-pink-900"
              >
                Search Jobs by City
              </div>
              <button
                onClick={() => navigate("/review/companies")}
                type="button"
                className="text-white flex items-center justify-center absolute right-2.5 bottom-2.5 bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-pink-900 font-medium rounded-lg text-sm px-4 py-2"
              >
                Review <FaArrowRightLong className="ml-2" />
              </button>
            </div>
            
            <div className="relative w-full max-w-xs">
              <div className="block w-full mb-2 text-sm font-medium text-white">
                Write your Interview Experience
              </div>
              <div
                id="default-search"
                className="block w-full p-4 text-sm text-pink-900 border border-pink-900 rounded-lg bg-white focus:ring-pink-900 focus:border-pink-900"
